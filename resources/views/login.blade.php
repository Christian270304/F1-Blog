    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('login') }}" id="form">
            ...
            <div class="field">
                ...
                <input autocomplete="off" id="logemail" placeholder="Username" class="input-field" name="username" type="namespace" value="{{ old('username') }}">
            ...
            <div class="field">
                ...
                <input autocomplete="on" id="logpass" placeholder="Contrasenya" class="input-field" name="password" type="password" value="{{ old('password') }}">
            ...
            <a href="{{ route('password.request') }}" class="btn-link">Te has olvidado la contraseña?</a>
