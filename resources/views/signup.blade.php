    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('signup') }}" >
            ...
            <div class="field">
                ...
                <input autocomplete="off" id="logusername" placeholder="Nom d'usuari" class="input-field" name="username" type="text" value="{{ old('username') }}">
            </div>
            @error('username')
            ...
            <div class="field">
                ...
                <input autocomplete="off" id="logemail" placeholder="Correu electrònic" class="input-field" name="email" type="email" value="{{old('email')}}">
            </div>
            @error('email')
                <span class="error">{{ $message }}</span>
            @enderror
            <div class="field">
                ...
                <input class="input-field" autocomplete="on" placeholder="Contrasenya" name="password" type="password" value="{{old('password')}}">
            </div>
            @error('password')
                <span class="error">{{ $message }}</span>
            @enderror   
