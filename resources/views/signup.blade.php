    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('signup') }}">
            ...
            <div class="field">
                ...
                <input autocomplete="off" id="logemail" placeholder="Correu electrònic" class="input-field" name="email" type="email" value="">
            </div>
                @error('email')
                    <span class="error">{{ $message }}</span>
                @enderror
            <div class="field">
                ...
                <input autocomplete="off" placeholder="Contrasenya" class="input-field" name="password" type="password" value="">
            </div>
                @error('password')
                    <span class="error">{{ $message }}</span>
                @enderror
            <div class="field">
                ...
                <input autocomplete="off" placeholder="Repita la contraseña" class="input-field" name="confirm_password" type="password" value="">
            </div>
